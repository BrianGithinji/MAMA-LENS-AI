/**
 * MAMA-LENS AI — Grief Support Page
 * Compassionate support after pregnancy loss
 */
    ...
    <div className="min-h-screen bg-rose-50 pb-20">
      ...
      <div className="bg-gradient-to-br from-rose-400 to-pink-500 px-6 pt-10 pb-16 text-center">
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
          {/* Logo on white pill so line-art is visible over gradient */}
            ...
            {[
              {
                ...
                description: "Share your feelings with our compassionate AI assistant, available 24/7",
                href: "/avatar",
              ...
              },
              {
                ...
                description: "Africa Mental Health Foundation: +254 722 178 177",
              ...
              },
              {
                ...
                description: "Articles and guides on healing after pregnancy loss",
                href: "/education",
              ...
              external ? (
                <a key={title} href={href}
                  className="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl active:scale-95 transition-all">
